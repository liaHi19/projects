      ...
      <Container>
        <div className="flex items-center justify-between p-5 gap-6">
          <div className=" flex-1 xl:max-w-2xl text-center dark:text-text">
            ...
            <h3 className="mb-3 italic text-lg sm:text-2xl lg:text-4xl">
              <b>Software Developer</b>
            </h3>
            <p className="text-justify font-semibold text-sm sm:text-lg lg:text-xl mb-5">
              Skilled developer with a strong command over React.js and Node.js,
              equipped to build exceptional web applications. Feel free to reach
              out and discover more about my work.
            </p>
            ...
            <ul className="flex items-center justify-center gap-4">
              <li>
                <a
                  ...
                  target="_blank"
                >
                  <FiLinkedin className="text-xl hover:text-primary transition-transition" />
                </a>
              </li>
              <li>
                <a href="https://github.com/liaHi19" target="_blank">
                  <FaGithub className="text-xl hover:text-primary transition-transition" />
                </a>
              </li>
            </ul>
          </div>
